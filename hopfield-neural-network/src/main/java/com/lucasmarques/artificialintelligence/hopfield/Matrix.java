package com.lucasmarques.artificialintelligence.hopfield;
...
public class Matrix {
    ...
    public static double[][] createMatrix(int numberOfRows, int numOfCols) {
        return new double[numberOfRows][numOfCols];
    }
    ...
    public static double[][] clearDiagonoals(double[][] matrix) {
        for (int i = 0; i < matrix.length; i++) {
            matrix[i][i] = 0;
        }
        return matrix;
